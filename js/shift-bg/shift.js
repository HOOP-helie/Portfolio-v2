...
const yOff = 0.0015;
const zOff = 0.0015;
const backgroundColor = 'hsla(0,0%,60%,1)';
...
function initCircle(i) {
  ...
  hue = baseHue + Math.round(Math.random() * 100)
  // 150 for more pink, lower for more blue
...
function drawCircle(x, y, life, ttl, radius, hue) {
  ctx.a.save();
  ctx.a.fillStyle = `hsla(${hue}, 70%,60%,${fadeInOut(life, ttl)})`;
  ctx.a.beginPath();
